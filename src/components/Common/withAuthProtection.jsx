...
const withAuthProtection = WrappedComponent => {
  const AuthenticatedComponent = props => {
    ...
    const token = getCookie(process.env.NEXT_PUBLIC_AIVA_TOKEN_COOKIE);
    const allowedPages = JSON.parse(getCookie(process.env.NEXT_PUBLIC_AIVA_ALLOWED_PAGES_COOKIE));
